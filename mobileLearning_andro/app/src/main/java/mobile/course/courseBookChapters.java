...
public class courseBookChapters extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String param1 = bundle.getString("keyBookId");
	
		try {
			linkurl = new koneksi("/courseBookChapters.php?idb="+param1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		bundle.putString("keyChapNum", myRssFeed.getItem(position).getPubdate());
		bundle.putString("keyContent", myRssFeed.getItem(position).getDescription());
