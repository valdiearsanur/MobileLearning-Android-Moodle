...
public class tugasDetailUp extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		try {
			linkurl = new koneksi("/tugasUpdate.php?idc="+param1+"&idu="+param2);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(this,tugasDetailJsUp.class);
		...
		bundle.putString("keyAssignId", myRssFeed.getItem(position).getLink());
		bundle.putString("keyCourseId", myRssFeed.getItem(position).getPubdate());
		bundle.putString("keyAssignSubId", myRssFeed.getItem(position).getCategory());
