...
public class tugasDetailJsUp extends Activity  {
   ...
   String SERVER_URL ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.showdetailtugasupdate);
        ...
        final String param4 = bundle.getString("keyAssignSubId");
        
        
        Button uploadUpdate = (Button) findViewById(R.id.updateUpload);
        uploadUpdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String AssignSubId = param4;
				Intent iUpload = new Intent(tugasDetailJsUp.this, uploadUpdate.class);
				
				String txtCourseId = String.valueOf(courseId);
				String txtTugasId = String.valueOf(tugasId);
				String txtUserId = String.valueOf(userId);
				String txtAssignSubId = String.valueOf(AssignSubId);
				...
				bundle.putString("idas", txtAssignSubId);
        ...
        Button bt_jawaban = (Button) findViewById(R.id.kirimUpdate);
        bt_jawaban.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
	            ...
	            try {
	            	linkurl = new koneksi("/tugasKirimTeksUpdate.php?idtgs="+param2+"&idu="+param3+"&idas="+param4);
	               ...
	               if(res.equals("1")){
	            	   createDialog("Selamat", "Jawaban Anda Berhasil Di Update ^_^");
	               }else
	               {
	            	   createDialog("Maaf", "Jawaban Anda Gagal Update T_T waktu untuk update telah habis");
	               }
	            }
             ...
             try {
                ...
                for(int i=0;i<jArr.length();i++){
                   ...
                   String alltext = jObj.getString("description");
                    String jwb = jObj.getString("data1");
