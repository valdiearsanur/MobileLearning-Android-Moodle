...
public class tugasUp extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String param1 = bundle.getString("username");
		
		SERVER_URL = SERVER_URL+"?uname="+param1;
		try {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(this,tugasDetailUp.class);
