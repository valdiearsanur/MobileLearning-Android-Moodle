...
public class nilaiDetail extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		try {
			linkurl = new koneksi("/nilai.php?idc="+param1+"&idu="+param2);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(this,nilaiDetailJs.class);
		Bundle bundle = new Bundle();
		bundle.putString("keyCourseName", myRssFeed.getItem(position).getTitle());
		bundle.putString("keyAssignId", myRssFeed.getItem(position).getDescription());
		bundle.putString("keyUserId", myRssFeed.getItem(position).getLink());
		bundle.putString("keySubmisId", myRssFeed.getItem(position).getPubdate());
